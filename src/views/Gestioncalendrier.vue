...
export default {
  ...
  methods: {
    ...
    changer(val, i, j, index) {
            ...
            if(this.listDays[i].length == 1) {

              this.listDays[i][j]._id = null;
              ...
              this.listDays[i][j].valider = false;
              this.listDays[i][j].mois = null;
              this.listDays[i][j].annee = null;
              this.listDays[i][j].matricule = null;
              this.listDays[i][j].notification = false;
              this.listDays[i][j].date = null;
            }
            ...
            .then((result) => {
                ...
                if(result) {
                        ...
                        this.listDays[i][j]._id = null;
                        this.listDays[i][j].number = null;
                        this.listDays[i][j].jour = null;
                        this.listDays[i][j].annee = null;
                        this.listDays[i][j].date = null;
                        this.listDays[i][j].titre = null;
                        this.listDays[i][j].client = null;
                        this.listDays[i][j].matricule = null;
                        this.listDays[i][j].mois = null;
                        this.listDays[i][j].notification = null;
                        this.listDays[i][j].valider = null;
                        this.listDays[i][j].lieu = null;
                        this.listDays[i][j].inspecteur[0].name = null;
                        this.listDays[i][j].horaire[0].start = null;
                        this.listDays[i][j].horaire[0].fin = null;
