<template>
    <div class="gestionInspecteur"  >
      ...
      <h3 v-if="flagImportFacture == false">Facture émise</h3>
      <div v-if="flagImportFacture == false" class="rechercher-table">
            ...
            <table id="inspecteurs">
              ...
              <tr v-for="(affaire, i) in filterAffaires" :key="affaire._id">
                ...
                <td v-if="affaire.facture == 'false'" style="background-color: white; margin : 0; padding: 0; padding-bottom: 5px; padding-left: 5px;" @click="handelInsertFacture(affaire._id)"><p style="font-size: 25px; color:red; font-wight: bold; font-weight: bold;">FA</p><i class="fa-solid fa-forward-step" style="font-size: 25px; color:red;"></i></td>
                ...
                <td v-show="affaire.emise == 'false'" style="background-color: white; margin : 0; padding: 0; padding-bottom: 5px; padding-left: 5px;" @click="handelInsertEmise(affaire._id, i)"><p style="font-size: 25px; color:red; font-wight: bold; font-weight: bold;">EN</p><i class="fa-solid fa-forward-step" style="font-size: 25px; color:red;"></i></td>
