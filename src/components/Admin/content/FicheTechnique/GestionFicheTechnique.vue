<template>
    ...
    <div class="gestionInspecteur">
      ...
      <h3 v-if="flagEditFicheTechnique == false" >GESTION DES FICHES TECHNIQUES MATÉRIEL</h3>
            ...
            <table id="inspecteurs">
              ...
              <tr v-for="(item, i) in filterFicheTechniques" :key="item._id">
                ...
                <td>
                  ...
                  <a @click="certficatFicheTechnique(item.filename)"><i class="fa-solid fa-certificate"></i></a>
                </td>
              </tr>
            </table>
