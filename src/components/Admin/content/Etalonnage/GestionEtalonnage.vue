<template>
    ...
    <div class="gestionInspecteur">
      ...
      <h3 v-if="flagEditEtalonage == false" >FICHES DES ÉTALONNAGE</h3>
      ...
      <div class="rechercher-table" v-if="flagEditEtalonage == false">
            ...
            <table id="inspecteurs">
              ...
              <tr v-for="(item, i) in filterEtalonnages" :key="item._id">
                ...
                <td v-if="new Date(new Date(item.prochaineEtalonnage).getFullYear(), new Date(item.prochaineEtalonnage).getMonth(), new Date(item.prochaineEtalonnage).getDate()-90).toLocaleDateString() >= new Date(item.prochaineEtalonnage).toLocaleDateString()" style="color: white; background-color: red;">{{ new Date(item.prochaineEtalonnage).toLocaleDateString() }}</td>
                ...
                <td>
                  ...
                  <a @click="certficatEtalonnage(item.filename)"><i class="fa-solid fa-certificate"></i></a>
                </td>
              </tr>
            </table>
