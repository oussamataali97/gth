  ...
  <div class="creationClient">
    ...
    <div class="formCreation">
      ...
      <div>
        ...
        <input type="file" multiple="multiple" placeholder="Télécharger Certificat" ref="diplome" @change="previewDIPLOME">
      </div>
      ...
      <div>
        ...
        <input type="file" multiple="multiple" placeholder="Télécharger CIN" ref="cin" @change="previewCIN">
      </div>
      ...
      <div>
        ...
        <input type="file" multiple="multiple" placeholder="Télécharger CIN" ref="photo" @change="previewPHOTO">
      </div>

      <div>
        <label for="Documents Médical">Documents Médical</label>
        <input type="file" multiple="multiple" placeholder="Télécharger CIN" ref="medical" @change="previewMEDICAL">
      </div>

      <div>
        <label for="Autres Documents">Autres Documents</label>
        <input type="file" multiple="multiple" placeholder="Télécharger CIN" ref="autres" @change="previewAUTRES">
      </div>
      <div>
...
#app > div > div > div.menu-content > div.content > div > div > div > div:nth-child(25) > input[type=submit] {
...
#app > div > div > div.menu-content > div.content > div > div > div > div:nth-child(26) > input[type=submit]{
    background-color: red;
    color: white;
    border: 0;
    margin-top: 30px;
