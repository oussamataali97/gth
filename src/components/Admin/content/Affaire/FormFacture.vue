  ...
  <div class="all" style="width:100%;">
    ...
    <div class="form" v-if="flagMession">
        ...
        <div style="width :30%;">
          ...
          <input class="annuler" type="submit" value="Annuler" @click="annulerEquipement()">
        </div>
        ...
        <div style="width :30%;">
          <label for="Annuler">Cliquer pour Annuler cet mission</label>
          <input class="annuler" type="submit" value="Annuler" @click="$emit('annuleFacture')">
        </div>

        <div style="width :30%;">
          <label for="Ajouter">Cliquer pour ajouter un autre mission</label>
          <input class="ajouter" type="submit" value="Ajouter" @click="$emit('ajouteFacture')">
        </div>
    ...
    <div class="form" v-if="flagMession == false">
        <div style="width :30%;">
          <label for="Aperçu">Cliquer pour aperçu cet mission</label>
          <input class="apercu" type="submit" value="Aperçu" @click="apercu(missionId)">
        </div>
